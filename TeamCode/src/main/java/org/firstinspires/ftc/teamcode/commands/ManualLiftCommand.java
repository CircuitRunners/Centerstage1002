...
public class ManualLiftCommand extends CommandBase {
    ...
    public void execute() {
        ...
        //Otherwise, do nothing
            ...
            else if (lift.getLiftPosition() < 283)
                lift.setLiftPower(1); //0.19 * lift.getVoltageComp()
            else if (lift.getLiftPosition() < 580)
                lift.setLiftPower(1); //0.20 * lift.getVoltageComp()
