...
//
//import org.firstinspires.ftc.teamcode.auto.MappedTrajectorySequenceBuilder;
...
////@Photon
//@Autonomous (name="RED AUDIENCE FL(INT)")
...
//
//    private Pose2d startPose = new Pose2d(-39.75, -63, Math.toRadians(90.00));
//
...
//        switch (locationID) {
//            case LEFT: {
//                ONE_GLOBAL = new MappedTrajectorySequenceBuilder(drive, startPose)
//                        .lineToLinearHeading(new Pose2d(-43.71, -35.39, Math.toRadians(150.00)))
//                        .lineTo(new Vector2d(-36.20, -38.09))
//                        .lineToLinearHeading(new Pose2d(-34.32, -9.56, Math.toRadians(0.00)))
//                        .build();
//                THREE_PIXEL_ON_BACKDROP = new MappedTrajectorySequenceBuilder(drive, new Pose2d(30.64, -11.30, Math.toRadians(0)))
//                        .lineTo(new Vector2d(32.64, -28.47))
//                        .lineTo(new Vector2d(48.72, -28.47))
//                        .build();
//                break;
//            }
//            case MIDDLE: {
//                ONE_GLOBAL = new MappedTrajectorySequenceBuilder(drive, startPose)
//                        .lineToLinearHeading(new Pose2d(-36.74, -33.91, Math.toRadians(90.00)))
...
//
//                THREE_PIXEL_ON_BACKDROP = new MappedTrajectorySequenceBuilder(drive, new Pose2d(30.64, -11.30, Math.toRadians(0)))
//                        .lineTo(new Vector2d(32.67, -36))
//                        .lineTo(new Vector2d(48.22, -36))
//                        .build();
//                break;
//            }
//            case RIGHT: {
//                ONE_GLOBAL = new MappedTrajectorySequenceBuilder(drive, startPose)
//                        .lineToLinearHeading(new Pose2d(-39.75, -35.13, Math.toRadians(30.00)))
//                        .lineTo(new Vector2d(-36.64, -35.13))
//                        .lineTo(new Vector2d(-42.53, -38.49))
//                        .lineToLinearHeading(new Pose2d(-34.32, -9.56, Math.toRadians(0.00)))
//                        .build();
//
//                THREE_PIXEL_ON_BACKDROP = new MappedTrajectorySequenceBuilder(drive, new Pose2d(30.64, -11.30, Math.toRadians(0)))
//                        .lineTo(new Vector2d(32.64, -44))
//                        .lineTo(new Vector2d(52.22, -44))
//                        .build();
//                break;
//            }
//        }
