...
@Autonomous(name = "Right 1+4 M", group = "Medium")
public class RightMediumFourCycleAuto extends CommandOpMode {
...
//        PhotonCore.enable();
        ...
        DropPreloadCommand preloadCommand =
                new DropPreloadCommand(drive, lift, claw, arm, false);
